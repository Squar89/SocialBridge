...
app = FastAPI(
    ...
    summary="A sample application showing how to use FastAPI\
    to add a ReST API to a MongoDB collection.",
)
...
app.add_middleware(
    ...
    allow_methods=["*"],  # Can restrict to ["GET", "POST"]
    allow_headers=["*"],  # Can restinct to given headers
)
...
async def update_student(id: str, student: UpdateStudentModel = Body(...)):
    ...
    Only the provided fields will be updated. Any missing or `null`
